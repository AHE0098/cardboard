  ...
  
{
  ...
  embeddedCards: {
    "card_000": {
      ...
      originalType: "Tree",
      traits: [],
      text: "Generate 1 Thorn resource for the current phase."
    },
    "card_001": {
      name: "Thorn Tree",
      color: "Thorn",
    ...
    "card_014": {
      ...
      type: "creature",
      originalType: "Animal",
      traits: ["stampede", "drinking"],
      text: "Damage spillover: If this deals lethal damage to an animal, excess damage hits the player. Drunk Tokens penalty replacing normal damage."
    },
    "card_015": {
      name: "Thorn Tree",
      color: "Thorn",
    ...
    "card_031": {
      ...
      originalType: "Vibe",
      traits: [],
      text: "Attach to an Animal. Gains Collateral. When this Vibe is killed, opponent gets 2 Drunk tokens."
    },
    "card_032": {
      name: "Thorn Tree",
      color: "Thorn",
